```markdown
---
name: Project Guidelines Skill (Example)
description: 这是一个针对特定项目的示例技能。将其用作您自己项目的模板。
tools:
  - Next.js
  - FastAPI
  - Supabase
...
- **部署**：Google Cloud Run
- **测试**：Playwright（端到端）、pytest（后端）、React Testing Library
...
1. 代码、注释或文档中**禁止使用表情符号**
2. **不可变性** - 永远不要修改对象或数组
3. **测试驱动开发（TDD）** - 先写测试再实现
4. **最低覆盖率 80%**
5. **多文件拆分** - 通常 200-400 行，最多 800 行
6. 生产代码中**禁止使用 console.log**
7. 使用 try/catch 实现**正确的错误处理**
